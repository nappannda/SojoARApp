...
public class MainActivity extends AppCompatActivity {
    ...
    private void permissionsNotSelected() {
        ...
        builder.setTitle(getText(R.string.permissionsRequred));
        builder.setMessage(getText(R.string.permissionsMessage));
        builder.setNeutralButton(getText(R.string.exit), new DialogInterface.OnClickListener() {
